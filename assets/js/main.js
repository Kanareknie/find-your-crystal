...
// Helper functions
// List of SubPowers used in num and zodiac pages

function renderSubPowers(crystal, selector) {
  var subPowersEl = document.querySelector(selector);
  var subList;
  var i;
  var li;
...
if (zodiacFormSelect && zodiacSelect && crystalListEl && questionSection && answerSection) {
  ...
  function renderCrystalDetails(crystal) {
    ...
    if (crystal.image) {
      ...
      // Subpowers list of results - call the function
      renderSubPowers(crystal, "[data-field=\"subPowers\"]");
